...
def main():
    ...
    pd.DataFrame.from_records(hist_record_list).fillna(0.).set_index("specimen_id").to_csv(output_hist_file)
    pd.DataFrame.from_records(soma_record_list).fillna(0.).set_index("specimen_id").to_csv(output_soma_file)
