...
class LayerAlignedSwcSchema(ags.ArgSchema):
    ...
    ccf_slice_orientation_correction = ags.fields.Boolean(
        default=True,
        description="When skeleton_keys.cmds.full_morph_layer_drawings was used to generate -swc_path and -surface_and_layers_file this will rotate the upright morphology about the soma-centered y-axis so that the result is near coronal orientation."
    )
